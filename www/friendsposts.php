<?php
	...
	include getcwd().'/dcnt20.php';
		...
		AND posts.type =  'F' AND secur.friends = '1' AND CAST(posts.k1 as UNSIGNED) > ".$startKey." ORDER BY posts.date DESC LIMIT ".$limit;
		$q = $db1->prepare($sql);
		...
		updateViews($userid,'friends', $resultViews['keyValue']);
